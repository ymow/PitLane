...
### 🌎 News & Intelligence
- [x] **RSS Pipeline**: Basic multi-source fetching (Fixed Entity Extraction Fallback).
...
3. **[DON-1] Env Fix**: Resolving Python 3.13 dependency conflicts for Spacy (Fixed via Regex Fallback).
4. **[RSS-001] Translation Backfill**: Automated pipeline for zh-TW without external API cost.
